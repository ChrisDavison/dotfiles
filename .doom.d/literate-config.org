#+TITLE: Config
#+PROPERTY: header-args :tangle "literate-config.el" :results silent

In order to run this, need something like the following inside doom's =config.el= (or a standard emacs =init.el=)
  ...
  (let* ((date (org-read-date nil t))
    ...
    (cond
     ...
     (t
      (beginning-of-line 1)
      (insert datestr "\n")
      ;; not sure if this is what causes new logbooks
      ;; taking a subheading from the previous header
      ;; (previous-line)
      )
     )
    ))
