...
(setq org-capture-templates
      (doct `((,(faicon-heading "sticky-note" "TODO") :keys "t"
              ...
              (,(faicon-heading "sticky-note" "TODO [WORK]") :keys "w"
               :file "work.org" :headline "TASKS"
               :type entry :template "* TODO %?")

              (,(faicon-heading "sticky-note" "RESEARCH") :keys "r"
               :file "todo.org" :headline "RESEARCH"
               :type entry :template "* TODO %?")

              (,(octicon-heading "comment" "NOTE") :keys "n"
              ...
              (,(octicon-heading "comment" "Logbook") :keys "l"
              ...
              (,(octicon-heading "book" "Korean") :keys "k"
