      ...
      (doct `(
              ("TODO" :keys "t"
               ...
               :children (("TODO [Personal]" :keys "t" :file "todo.org")
                          ("TODO [Work]" :keys "w" :file "work.org" :headline "TASKS")))
              ...
              ("JOURNAL" :keys "j"
               :file (lambda () (interactive) (cd/org-file-today "journal"))
               :type entry
               :children (("Journal [Today]" :keys "j"
                           :file (lambda () (interactive) (cd/org-file-today "journal"))
                           :template "* %t %?")
                          ("Journal [Future]" :keys "J"
                           :file (lambda () (interactive) (cd/org-file-future "journal"))
                           :template "* %(concat \"<\" cd/last-future-date \"> \") %^{Title}\n:PROPERTIES:\n:CATEGORY: Journal\n:END:\n\n%?")))

              ("LOGBOOK" :keys "l"
               :file (lambda () (interactive) (cd/org-file-today "logbook"))
               :type entry
               :children (("Logbook [Today]" :keys "l"
                           :file (lambda () (interactive) (cd/org-file-today "logbook"))
                           :template "* %t %?")
                          ("Logbook [Future]" :keys "L"
                           :file (lambda () (interactive) (cd/org-file-future "logbook"))
                           :template "* %(concat \"<\" cd/last-future-date \"> \") %^{Title}\n:PROPERTIES:\n:CATEGORY: Logbook\n:END:\n\n%?")))
              ...
              ("URL" :keys "u"
               ...
               :headline "Bookmarks"
               :type entry
               :children (("URL from clipboard" :keys "u"
                           :template "* TODO [[%c][%^{URL Title}]]\n\nWhy did this interest me? %?")
                          ("Org-link from clipboard" :keys "o"
                           :template "* TODO %c\n\nWhy did this interest me? %?")))
              ...
              ;; ("Korean" :keys "k"
              ;;  :file "korean.org" :headline "Vocabulary"
              ;;  :type entry
              ;;  :immediate-finish t
              ;;  :template "* TODO %^{Word}")
              )))
...
(defvar cd/agenda/work-filenames
  '("work.org" "thesis.org" "logbook" "literature.org")
...
(defun cd/work-files ()
  (append '("work.org" "thesis.org" "engd.org")
          (cd/org-files-under-dir "logbook")
