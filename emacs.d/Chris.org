...
** colour theme 
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (setq theme_dark nil)
     (setq dark_theme 'sanityinc-tomorrow-night)
     (setq light_theme 'dl)
...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    (setq org-default-notes-file "~/Dropbox/notes-org/inbox.org")
...
#+BEGIN_SRC emacs-lisp
  (setq org-capture-templates
        '(("q" "quotes" entry
           (file "~/Dropbox/notes-org/quotes.org")
           "* %^{WHAT} ** %^{WHO? WHERE?}\n%^{QUOTE}"
           :immediate-finish)

          ("t" "todo" entry
           (file+headline "~/Dropbox/notes-org/todo.org" "REFILE")
           "** -TODO- %^{PROJECT} :: %^{Task}\n%^{WHEN?}t\n%^{DETAILS}"
           :immediate-finish)

          ("e" "engd" entry
           (file+headline "~/Dropbox/notes-org/inbox.org" "EngD")
           "** %^{WHAT}\n%?"
           :immediate-finish)

          ("l" "logbook" item
           (file+datetree "~/Dropbox/notes-org/engd/logbook2016.org")
           "%^{LOGBOOK ENTRY}\n\n"
           :immediate-finish)

          ("n" "note" item
           (file+headline "~/Dropbox/notes-org/inbox.org" "REFILE")
           "%^{NOTE}\n"
           :immediate-finish)
...
#+BEGIN_SRC emacs-lisp :results no
  (setq org-agenda-files '("~/Dropbox/notes-org/inbox.org"
                           "~/Dropbox/notes-org/engd/logbook2016.org"
                           "~/Dropbox/notes-org/todo.org"
                           ))
#+END_SRC
