...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ace-isearch virtualenvwrapper elpy magit exec-path-from-shell guide-key f s counsel ivy fold-dwim-org fold-dwim ibuffer-vc switch-window smartscan anzu dired+ cargo company flycheck-rust flymake-rust rust-mode go-mode rainbow-mode js-comint nodejs-repl coffee-mode json-mode js2-mode scss-mode sass-mode haml-mode emmet-mode lua-mode csv-nav pandoc-mode markdown-mode flycheck-clojure aggressive-indent expand-region evil-smartparens smartparens key-chord evil-leader evil-surround evil tao-theme color-theme-sanityinc-tomorrow seoul256-theme molokai-theme solarized-theme fullframe use-package))))
(custom-set-faces
