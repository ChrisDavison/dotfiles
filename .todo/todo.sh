...
shorthelp()
{
    ...
    addonHelp | grep -e '^  Add-on Actions (.todo.actions.d/<addon>)' -e '^    [[:alpha:]]'
...
actionsHelp()
{
    cat <<-EndActionsHelp
		  Built-in Actions:
            ...
            adda "THING I NEED TO DO +project @context"
              Adds THING I NEED TO DO to your todo.txt file on its own line,
              and prioritises as 'A'
		      Project and context notation optional.
		      Quotes optional.
...
addonHelp()
{
    if [ -d "$TODO_ACTIONS_DIR" ]; then
        ...
        do
		  ...
		  Add-on Actions (.todo.actions.d/<addon>)
