...
(setq org-capture-templates
      `(
        ...
        ("td" "Task (Dated)" item (file+headline "inbox.org" "Tasks")
         "[ ] %^t %^{TASK}" :immediate-finish t)
        ("tT" "Project" entry (file "inbox.org")
         "* TODO %^{TASK}\n%?" :empty-lines 1)
        ("tA" "Add to Anki" item (file+headline "inbox.org" "Tasks")
         "[ ] *(Anki)*  %^{knowledge}" :immediate-finish t)
        ("tb" "Buy" item (file+headline "inbox.org" "Tasks")
         "[ ] *($)* %^{Buy}" :immediate-finish t)
        ("tw" "WORK Task" item (file+headline "work.org" "TASKS")
         "[ ] %^{Task}" :immediate-finish t)
        ("tW" "WORK Project" entry (file "work.org")
         "* TODO %^{Task}\n%?" :empty-lines 1)
        ...
        ("n" "Note" plain (file+headline "notes.org" "Notes")
         "%?" :empty-lines 1)
        ...
        ("a" "Article" entry (file+headline "work.org" "Literature")
         "* TODO %^{Article}\n\nAbstract: %?"
         :prepend t)
