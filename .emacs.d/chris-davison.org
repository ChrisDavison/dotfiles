...
(setq ibuffer-saved-filter-groups
      '(("home"
         ("emacs-config" (or (filename . ".emacs.d") (filename . "chris-davison.org") (filename . "chris-davison.el")))
         ("Notes" (and (mode . org-mode) (filename . "Dropbox/notes/")))
          )))
#+END_SRC
...
(setq org-capture-templates
      '(
        ...
        ("c" "Code Snippet" entry
         (file+heamdline "~/Dropbox/notes/inbox.org" "Notes")
         "* CODE: %^{Snippet Topic}\n#+BEGIN_SRC %^{Language}\n%c\n#+END_SRC\n"
         :immediate-finish 1)
...
#+BEGIN_SRC emacs-lisp
(message (s-concat "Config loaded: " (emacs-init-time)))
#+END_SRC
