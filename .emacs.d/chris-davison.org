...
(setq ibuffer-saved-filter-groups
      '(("home"
         ("notes" (and (filename . "knowledge/")
                       (or (mode . org-mode) (mode . dired-mode))))
         ("dotfiles" (filename . "dotfiles/"))
         ("code" (filename . "code/"))
         ("work" (or (filename . "cybele-sat/")
                     (filename . "ee273/")
                     (filename . "precisionbeef/")
                     (filename . "cowhealth/")
                     (filename . "cattleprod/")
                     (filename . "cidcom-howtos/")
                     (filename . "collar-outlier-removal/")
                     (filename . "heatstress/")))
         ("code" (filename . "code/"))
         )))
...
(use-package org-roam
  ...
  :custom
  (org-roam-directory "~/code/knowledge")
...
(defhydra hydra/bookmarks (:hint nil :exit t)
  ...
  ("p" (find-file "~/code/knowledge/projects.org") "projects")
  ("l" (find-file "~/code/knowledge/logbook.org") "logbook")
  ("i" (find-file "~/code/knowledge/inbox.org") "inbox")
  ("s" (find-file "~/Dropbox/shopping.txt") "shopping")
  ("q" nil nil))
#+end_src
** Windows / splits
#+begin_src emacs-lisp
...
(defvar cd/preferred-windows-font "JetBrains Mono")
(defvar cd/preferred-linux-font "JetBrains Mono")
(cond
...
#+BEGIN_SRC emacs-lisp
(set-register ?p (cons 'file "~/code/knowledge/projects.org"))
...
(defun cd/placeholder-jump ()
  (interactive)
  (goto-line 1)
  (re-search-forward "<<placeholder>>" nil t))
