...
(defhydra cd/links (:exit t)
  ...
  ("o" org-open-at-point "Open link" :column "Handle")
  ("O" cd/org-open-link-same "Open in same window" :column "Handle"))
...
(defhydra cd/windowmove (:exit t)
  ...
  (">" indent-rigidly-right-to-tab-stop "Indent to tabstop" :column "Windows" :exit nil)
  ("<" indent-rigidly-left-to-tab-stop "Dedent to tabstop" :column "Windows" :exit nil)
...
(defhydra hydra-fold (:pre (hs-minor-mode 1) :hint t :exit t)
  "fold"
