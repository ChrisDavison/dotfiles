...
(defhydra cd/latex/hydra (:exit t)
  ""
  ("i" cd/latex/italic "italic")
  ("b" cd/latex/bold "bold")
  ("v" cd/latex/verb "verbatim"))
...
(defhydra cd/hydra/main (:hint nil :exit t)
  ...
  _R_efile to file  | Indent line _<_/_>_ | _l_atex
  "
...
#+BEGIN_SRC emacs-lisp
(defun cd/latex/wrap (&optional pre post)
  (interactive)
  (let* ((start (region-beginning))
         (end (region-end))
         (prefix (if pre pre (read-string "Pre: ")))
         (postfix (if post post (read-string "Post: "))))
         (kill-region start end)
         (insert prefix)
         (yank)
         (insert postfix)))

  (defun cd/latex/italic ()
    (interactive)
    (cd/latex/wrap "\\textit{" "}"))
