...
(setq org-capture-templates
      `(
        ...
        ("tu" "URL" entry (file+headline "inbox.org" "Tasks")
         "* TODO [[%c][%^{DESCRIPTION}]]" :unnarrowed t :empty-lines 1)
        ("ta" "Add to Anki" item (file+headline "inbox.org" "Add to Anki")
         "[ ] %^{knowledge}" :immediate-finish t :unnarrowed t)
        ...
        ("l" "Logbook" plain
         (file+headline "logbook.org" ,(format-time-string "[%Y-%m-%d %a]"))
         "%?" :empty-lines 1 :unnarrowed t)
