...
(use-package org
  ...
  (setq org-directory "~/Dropbox/notes"
        ...
        org-agenda-files '("~/Dropbox/notes/calendar.org" "~/Dropbox/notes/inbox.org" "~/Dropbox/notes/projects/")
...
(setq cd-org-capture-templates
      `(
        ...
        ("b" "book" entry (file+headline "books-to-read.org" "REFILE") "** %?")
...
(setq cd-fonts
      (cl-remove-if (lambda (font) (not (member font (font-family-list))))
                    '("JetBrains Mono" "Inconsolata" "Source Code Pro" "Cascadia Code" "Fantasque Sans Mono" "CamingoCode" "Roboto Mono" "Ubuntu Mono" "Liberation Mono" "Fira Code")))
(when cd-fonts
...
(set-face-attribute 'default nil :height (if (eq system-type 'windows-nt) 140 180))
