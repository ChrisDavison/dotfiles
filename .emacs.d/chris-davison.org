...
(setq org-capture-templates
      `(
        ...
        ("L" "link" plain (file+headline "inbox.org" "Notes")
         "[[%^{URL}][%^{Description}]] %?" :empty-lines 1)
...
#+BEGIN_SRC emacs-lisp
(global-set-key (kbd "M-4") 'company-ispell)
#+END_SRC

#+BEGIN_SRC emacs-lisp
(setq ispell-personal-dictionary (expand-file-name "~/code/dotfiles/ispell_dict")
      ispell-complete-word-dict (expand-file-name "~/code/dotfiles/ispell_dict"))
#+END_SRC
