...
CRUNCH_GIT_="$CRUNCH_BRACKET_COLOR"["$(git_prompt_info)$CRUNCH_BRACKET_COLOR"]"%{$reset_color%}"

# Put it all together!
PROMPT="$CRUNCH_TIME_$CRUNCH_GIT_$CRUNCH_DIR_$CRUNCH_PROMPT%{$reset_color%}"
