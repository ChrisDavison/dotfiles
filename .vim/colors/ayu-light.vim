...
let s:palette.bg        =   "#FAFAFA"

let s:palette.comment   =   "#ABB0B6"
let s:palette.markup    =   "#F07178"
let s:palette.constant  =   "#A37ACC"
let s:palette.operator  =   "#E7C547"
let s:palette.tag       =   "#36A3D9"
let s:palette.regexp    =   "#4CBF99"
let s:palette.string    =   "#86B300"
let s:palette.function  =   "#F29718"
let s:palette.special   =   "#E6B673"
let s:palette.keyword   =   "#FF7733"

let s:palette.error     =   "#FF3333"
let s:palette.accent    =   "#FF6A00"
let s:palette.panel     =   "#FFFFFF"
let s:palette.guide     =   "#D9D8D7"
let s:palette.line      =   "#F3F3F3"
let s:palette.selection =   "#F0EEE4"
let s:palette.fg        =   "#5C6773"
let s:palette.fg_idle   =   "#828C99"
