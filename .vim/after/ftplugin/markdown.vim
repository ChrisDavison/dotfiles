...
let g:pandoc#syntax#conceal#blacklist=['ellipses', 'atx', 'subscript', 'superscript', 'strikeout', 'codeblock_start', 'codeblock_delim', 'footnote', 'definition']
...
let g:forced_plaintext_files=['calendar.txt', 'todo.txt', 'shopping.txt']
